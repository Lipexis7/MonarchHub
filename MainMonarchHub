...
local Window = OrionLib:MakeWindow({Name = "Monarch Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Monarch Hub"})
...
W:AddLabel("[+] Monarch Hub is HERE!")
